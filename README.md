...
| --------------------------------------------------------------- | ------------------------------- | -------------------------------------------- |
| [Wikipedia](https://en.wikipedia.org/wiki/Berlin)               | Web scraping with BeautifulSoup | City, country, coordinates, population       |
| [OpenWeather](https://openweathermap.org/forecast5)             | REST API                        | 5-day weather forecast in 3-hour intervals   |
| [AeroDataBox](https://rapidapi.com/aedbx-aedbx/api/aerodatabox) | REST API via RapidAPI           | Nearby airports and next-day flight arrivals |
...
* [AeroDataBox via RapidAPI](https://rapidapi.com/aedbx-aedbx/api/aerodatabox)
